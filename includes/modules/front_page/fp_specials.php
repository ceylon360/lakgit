<?php
/*
  $Id: fp_specials.php v1.2 20130513 Kymation $
...
*/
  ...
  class fp_specials {
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_FRONT_PAGE_SPECIALS_SORT_ORDER', '50', 'Sort order of display. Lowest is displayed first.', '6', '0', now())");
