<?php
/*
  $Id: fp_scroller.php v1.1 20130513 Kymation $
  ...
  class fp_scroller {
    ...
    function execute() {
      ...
      if ($PHP_SELF == 'index.php' && $cPath == '') {
        ...
        $header .= '    $(function() {' . "\n";
        $header .= '			$("div#scroller").smoothDivScroll({' . "\n";
        ...
        $header .= '      $("#scroller").smoothDivScroll("startAutoScroll");' . "\n";
        $header .= '    }' . "\n";
        $header .= '    function stopScrolling() {' . "\n";
        $header .= '      $("#scroller").smoothDivScroll("stopAutoScroll");' . "\n";
        $header .= '    }' . "\n";
        $header .= '	</script>' . "\n";
        ...
        $header .= '	width: 5%;' . "\n";
        $header .= '	height: 100%;' . "\n";
        $header .= '	background-image: url(images/big_transparent.gif);' . "\n";
        ...
        $header .= '	left: 0;' . "\n";
        $header .= '  top: 0;' . "\n";
        $header .= '	cursor: url(images/cursors/cursor_arrow_left.cur), url(images/cursors/cursor_arrow_left.cur),w-resize;' . "\n";
        $header .= '}' . "\n\n";
        $header .= 'div.scrollingHotSpotLeftVisible {' . "\n";
        $header .= '	background-image: url(images/icons/arrow_left.png);' . "\n";
        ...
        $header .= '	right: 0;' . "\n";
        $header .= '  top: 0;' . "\n";
        $header .= '	cursor: url(images/cursors/cursor_arrow_right.cur), url(images/cursors/cursor_arrow_right.cur),e-resize;' . "\n";
        $header .= '}' . "\n\n";
        $header .= 'div.scrollingHotSpotRightVisible {' . "\n";
        $header .= '	background-image: url(images/icons/arrow_right.png);' . "\n";
        $header .= '	background-color: #fff;' . "\n";
        $header .= '	background-repeat: no-repeat;' . "\n";
        $header .= '	opacity: 0.35;' . "\n";
        $header .= '	filter: alpha(opacity = 35);' . "\n";
    ...
    function install() {
      $this->_load_header_tags_first();
    	...
    	tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_FRONT_PAGE_SCROLLER_SORT_ORDER', '40', 'Sort order of display. Lowest is displayed first.', '6', '0', now())");
