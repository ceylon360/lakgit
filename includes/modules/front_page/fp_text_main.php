<?php
/*
  $Id: fp_text_main.php v1.1 20130513 Kymation $
...
*/
  ...
  class fp_text_main {
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_FRONT_PAGE_TEXT_MAIN_SORT_ORDER', '15', 'Sort order of display. Lowest is displayed first.', '6', '1', now())");
