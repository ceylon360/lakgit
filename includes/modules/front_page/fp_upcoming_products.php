<?php
/*
  $Id: fp_upcoming_products.php v1.1 20130513 Kymation $
...
*/
  ...
  class fp_upcoming_products {
    ...
    function install() {
      ...
      tep_db_query( "insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_FRONT_PAGE_UPCOMING_PRODUCTS_SORT_ORDER', '55', 'Sort order of display. Lowest is displayed first.', '6', '0', now())");
