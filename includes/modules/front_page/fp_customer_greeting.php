<?php
/*
  $Id: fp_customer_greeting.php v1.1 20130513 Kymation $
...
*/
  ...
  class fp_customer_greeting {
    var $code = 'fp_customer_greeting';
    ...
    function install() {
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_FRONT_PAGE_CUSTOMER_GREETING_SORT_ORDER', '5', 'Sort order of display. Lowest is displayed first.', '6', '0', now())");
