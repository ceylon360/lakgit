...
*/
  ...
  class bm_categories {
    ...
    function execute() {
      ...
      $OSCOM_CategoryTree->setParentGroupString('<ul class="">', '</ul>', true);
   ...
   /* function isEnabled() {
	...
	//end for disable categories box
	function isEnabled() {
     global $PHP_SELF, $category_depth;
  if ((($PHP_SELF == 'login.php') and ($category_depth == 'top')) 
   || ($PHP_SELF == 'shopping_cart.php') 
   || ($PHP_SELF == 'login.php')
     || ($PHP_SELF == 'loginoff.php')
