...
define('JQUERY_DATEPICKER_FORMAT2', 'yy-mm-dd'); // see http://docs.jquery.com/UI/Datepicker/formatDate
...
define('ENTRY_STREET_ADDRESS_ERROR', 'Your Address must contain a minimum of ' . ENTRY_STREET_ADDRESS_MIN_LENGTH . ' characters.');
...
define('ENTRY_STATE', 'Nearest City');
define('ENTRY_STATE_ERROR', 'Your Nearest City must contain a minimum of ' . ENTRY_STATE_MIN_LENGTH . ' characters.');
define('ENTRY_STATE_ERROR_SELECT', 'Please select a Nearest City from the City pull down menu.');
