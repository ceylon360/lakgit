...
define('HEADING_TITLE', 'Sender Details');
...
define('TABLE_HEADING_NEW_PAYMENT_ADDRESS', 'Sender Details');
define('TEXT_CREATE_NEW_PAYMENT_ADDRESS', 'Please use the following form to Edit Sender Details to use for this order.');
