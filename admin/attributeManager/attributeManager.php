...
?>	
					...
					if(AM_USE_ATTRIBUTE_CODE) {
						echo 'Code :'.tep_draw_input_field("code_suffix_$optionValueId",$optionValueInfo['code_suffix'],' style="margin:3px 0px 3px 0px;" id="code_suffix_'.$optionValueId.'" size="7" onfocus="amF(this)" onblur="amB(this)" onChange="return amUpdate(\''.$optionId.'\',\''.$optionValueId.'\',\'code_suffix\');"');
						if (AM_USE_ATTRIBUTE_CODE_SORT) {
							echo tep_draw_input_field("suffix_sort_order_$optionValueId",$optionValueInfo['suffix_sort_order'],' style="margin:3px 0px 3px 0px;" id="suffix_sort_order_'.$optionValueId.'" size="2" onfocus="amF(this)" onblur="amB(this)" onChange="return amUpdate(\''.$optionId.'\',\''.$optionValueId.'\',\'suffix_sort_order\');"');
						}
					}
					?>
...
<!-- ----- -->
	...
	<table border="0"  cellpadding="0" cellspacing="0">
		<tr>
			...
			?>
			<td valign="top" class="newOptionPanel-label">
				<?php echo AM_AJAX_ATTRIBUTE_CODE; ?> <?php echo tep_draw_input_field('newCodeSuffix','','size="4" id="newCodeSuffix"'); ?>
			</td>
			<?php
			} else {
			?>
			<td valign="top">
				<?php echo tep_draw_hidden_field('newCodeSuffix','','size="4" id="newCodeSuffix"'); ?>
			</td>
			<?php
			}
			?>
